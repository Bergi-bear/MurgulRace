...
function CreateUnitsForPlayer0()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("n00A"), -6103.7, 3941.6, 93.120, FourCC("n00A"))
    u = BlzCreateUnitWithSkin(p, FourCC("n00A"), -6236.9, 3756.7, 93.120, FourCC("n00A"))
    u = BlzCreateUnitWithSkin(p, FourCC("n002"), -6116.0, 3545.0, 292.751, FourCC("n002"))
    u = BlzCreateUnitWithSkin(p, FourCC("n002"), -6075.4, 3670.5, 327.490, FourCC("n002"))
    u = BlzCreateUnitWithSkin(p, FourCC("n002"), -6007.4, 3548.0, 173.622, FourCC("n002"))
end
...
function CreateNeutralHostile()
    ...
    unitID = gg_rg_008[2]
    if (unitID ~= -1) then
        u = BlzCreateUnitWithSkin(p, unitID, -5234.0, 3781.1, 240.478, unitID)
        SetUnitAcquireRange(u, 200.0)
    end
    unitID = gg_rg_008[2]
    if (unitID ~= -1) then
        u = BlzCreateUnitWithSkin(p, unitID, -5108.4, 3741.4, 240.478, unitID)
        SetUnitAcquireRange(u, 200.0)
    end
    unitID = gg_rg_008[0]
    if (unitID ~= -1) then
        u = BlzCreateUnitWithSkin(p, unitID, -5178.6, 3660.9, 231.514, unitID)
        SetUnitAcquireRange(u, 200.0)
        t = CreateTrigger()
        TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
        TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
